...
const insertAbout = () => {
    ...
    <br><br>Life happened and I am losing my contracted position, so I made this page in an effort to prove competency and hopefully land a job. I know it's not world-beating, but I made it in about a day because, as my boss says "don't let perfect the enemy of good". I have other things to work on, which will be reference.</div>
    `;
